...
class Verduras : AppCompatActivity() {
    ...
    fun envioCarrito(view: android.view.View) {
        ...
        intentCarrito.putExtra("Aguacate", aguacate)
        intentCarrito.putExtra("arveja", arveja)
        intentCarrito.putExtra("berengena",berengena)
        intentCarrito.putExtra("brocoli",brocoli)
        intentCarrito.putExtra("espinaca",espinaca)
        intentCarrito.putExtra("guatila",guatila)
        intentCarrito.putExtra("pimenton",pimenton)
        intentCarrito.putExtra("tomate",tomate)
